...
public class Main {
	...
	public static void main(String[] args) throws IOException{
		dico.put("FMIN215","Algorithmique Géométrique");
		dico.put("GMIN20A","Algorithmique d'exploration et de mouvement");
		dico.put("GMIN212","Modélisation et programmation");
		dico.put("GMIN215","Analyse et traitement d'images");
		dico.put("GMIN21C","Conduite de projets");
